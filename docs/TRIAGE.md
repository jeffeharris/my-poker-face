...
| T3-17 | Schema version hardcoded, no migrations | `poker/repositories/schema_manager.py` | `SCHEMA_VERSION = 140` (as of 2026-06-03) with manual migration methods. No Alembic or equivalent. | **PLAN (2026-06-03)** — consolidation strategy in [`docs/plans/SCHEMA_BASELINE_PLAN.md`](/docs/plans/SCHEMA_BASELINE_PLAN.md): squash the v1..v140 chain at the prod cutover, gated by `tests/test_schema_consistency.py`. Adopting a real framework (Alembic) is deliberately deferred to *after* the squash, not bundled with it. |
...
*2026-06-03: refreshed god-file line counts (T3-41/42/43/45/46/47/48/49/50/51, T3-70) — several had drifted 2-3× since first triage (`game_handler.py` 1,465→4,634; `PersonalityManager.tsx` 1,989→3,225; `controllers.py` ~1,794→2,809). Current top god-files by line count: `schema_manager.py` 7,350 (fat-by-nature: DDL + v1→v140 migrations), `cash_routes.py` 6,530 (MA-16), `lobby.py` 5,018 (T2-75), `game_handler.py` 4,634 (T3-47), `tiered_bot_controller.py` 4,348 (MA-12).*
