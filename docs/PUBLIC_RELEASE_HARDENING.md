...
**Two ops actions to finish activating what's shipped:** set `ALERT_WEBHOOK_URL` (PRH-28 is a no-op until then) and confirm the `LLM_GLOBAL_DAILY_BUDGET_USD`/`LLM_PER_OWNER_DAILY_BUDGET_USD` defaults suit the launch (PRH-25).
