...
def init_persistence() -> None:
    ...
    global hand_history_repo, tournament_repo, coach_repo, relationship_repo, bankroll_repo, cash_table_repo, chip_ledger_repo, stake_repo, cash_session_repo, sandbox_repo, vice_state_repo, persistence_db_path
