...
def list_replay_experiments():
    ...
    try:
        ...
        result = experiment_repo.list_replay_experiments(
            status=status,
            limit=limit,
            offset=offset
        )
...
def create_replay_experiment():
    ...
    try:
        ...
        experiment_id = experiment_repo.create_replay_experiment(
            name=name,
...
def get_replay_experiment(experiment_id: int):
    ...
    """
    try:
        experiment = experiment_repo.get_replay_experiment(experiment_id)
        if not experiment:
...
def get_replay_results(experiment_id: int):
    ...
    try:
        ...
        result = experiment_repo.get_replay_results(
            experiment_id=experiment_id,
            variant=variant,
...
def get_replay_summary(experiment_id: int):
    ...
    """
    try:
        summary = experiment_repo.get_replay_results_summary(experiment_id)
...
def get_replay_captures(experiment_id: int):
    ...
    """
    try:
        captures = experiment_repo.get_replay_experiment_captures(experiment_id)
...
def get_capture_replay_comparison(experiment_id: int, capture_id: int):
    ...
    try:
        ...
        results = experiment_repo.get_replay_results(
            experiment_id=experiment_id,
            limit=100,
            offset=0
        )
