.PHONY: help build up down logs shell test test-quick test-strategy test-repos test-cash test-memory test-flask test-llm test-last validate-archetype-bands validate-economy-conservation clean prod testflight android-debug android-release
