...
from poker.strategy.preflop_classifier import build_preflop_node, get_6max_position
...
from poker.strategy.action_mapper import resolve_preflop_sizing
...
from poker.hand_tiers import (
    ...
    TOP_45_HANDS, TOP_55_HANDS, TOP_65_HANDS, TOP_75_HANDS,
    TOP_85_HANDS, TOP_95_HANDS,
)
...
class PlayerStats:
    ...
    def three_bet_pct(self) -> float:
        return (self.three_bet_count / self.three_bet_opportunities
                if self.three_bet_opportunities > 0 else 0)
...
def _build_mock_game_state(
    ...
    table_positions = {}
    pos_keys = ['button', 'small_blind_player', 'big_blind_player',
...
def main():
    ...
    parser.add_argument('--hands', type=int, default=1000,
                        help='Number of hands per archetype (default: 1000)')
