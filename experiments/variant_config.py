...
class VariantConfig:
    ...
    def resolve_prompt_config(self, prompt_preset_repo=None) -> Optional[PromptConfig]:
        ...
        Args:
            prompt_preset_repo: ExperimentRepository instance for loading presets
        ...
        if self.prompt_preset_id is not None and prompt_preset_repo is not None:
            preset = prompt_preset_repo.get_prompt_preset(self.prompt_preset_id)
    ...
    def resolve_guidance_injection(self, prompt_preset_repo=None) -> Optional[str]:
