...
def _counts(**over):
    base = {
        'hands_observed': 0, 'hands_dealt': 0,
        'vpip_count': 0, 'pfr_count': 0,
        'bet_raise_count': 0, 'call_count': 0,
        'showdowns_seen': 0, 'showdowns_won': 0,
        'all_in_count': 0,
        'fold_to_cbet_count': 0, 'cbet_faced_count': 0,
        'cbet_attempt_count': 0, 'postflop_seen_as_pfr_count': 0,
        'barrel_count': 0, 'barrel_opportunity_count': 0,
        'third_barrel_count': 0, 'third_barrel_opportunity_count': 0,
        'postflop_bet_raise_count': 0, 'postflop_call_count': 0,
        'equity_betting_count': 0, 'equity_raising_count': 0,
        'equity_calling_count': 0,
        'equity_betting_sum': 0.0, 'equity_raising_sum': 0.0,
        'equity_calling_sum': 0.0,
        'preflop_voluntary_action_count': 0, 'preflop_voluntary_opportunities': 0,
        'preflop_open_raise_count': 0, 'preflop_open_opportunities': 0,
    }
    base.update(over)
    return base
...
def test_pure_station_read():
    ...
    read = _read(_counts(
        hands_observed=120, hands_dealt=120,
        bet_raise_count=3, call_count=30,
        preflop_voluntary_action_count=90, preflop_voluntary_opportunities=100,
    ))
...
def test_sticky_jammer_read():
    ...
    read = _read(_counts(
        hands_observed=120, hands_dealt=120,
        bet_raise_count=3, call_count=30, all_in_count=12,
        preflop_voluntary_action_count=90, preflop_voluntary_opportunities=100,
    ))
...
def test_high_fold_to_cbet_read():
    ...
    # no archetype badge.
    read = _read(_counts(
        hands_observed=80, hands_dealt=80,
        bet_raise_count=10, call_count=10,
        fold_to_cbet_count=18, cbet_faced_count=20,
        preflop_voluntary_action_count=50, preflop_voluntary_opportunities=100,
    ))
...
def test_maniac_read():
    ...
    read = _read(_counts(
        hands_observed=60, hands_dealt=60,
        bet_raise_count=40, call_count=5,
        preflop_voluntary_action_count=80, preflop_voluntary_opportunities=100,
    ))
...
def test_cold_start_floor_suppresses_archetype():
    ...
    read = _read(_counts(
        hands_observed=10, hands_dealt=10,
        bet_raise_count=1, call_count=12,
        preflop_voluntary_action_count=9, preflop_voluntary_opportunities=10,
    ))
    assert read['archetype'] is None
...
def test_intensity_attached_when_available():
    read = _read(_counts(
        hands_observed=80, hands_dealt=80,
        bet_raise_count=10, call_count=10,
        fold_to_cbet_count=19, cbet_faced_count=20,
        preflop_voluntary_action_count=50, preflop_voluntary_opportunities=100,
    ))
