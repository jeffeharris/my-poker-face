...
from poker.prompt_manager import PERSONA_EXAMPLES, RESPONSE_FORMAT, PromptManager, PromptTemplate
...
def load_personalities_json():
    ...
    json_path = os.path.join(
        os.path.dirname(os.path.dirname(os.path.abspath(__file__))), 'poker', 'personalities.json'
    )
...
class TestPromptTemplate(unittest.TestCase):
    ...
    def test_render_basic(self):
        ...
        result = self.template.render(
            name='Alice', money=1000, greeting='Hi there', status='active'
        )
    ...
    def test_sections_joined_properly(self):
        ...
        result = self.template.render(name='Bob', money=500, greeting='Welcome', status='new')
