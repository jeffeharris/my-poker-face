...
from poker.poker_game import initialize_game_state, player_call, player_fold, player_raise
from poker.poker_state_machine import ImmutableStateMachine, PokerPhase, PokerStateMachine
...
class TestStateMachineCurrentBehavior(unittest.TestCase):
    ...
    def test_state_machine_in_games_dict(self):
        ...
        games = {}
        games['test_game'] = {'state_machine': self.sm, 'game_state': self.game_state}
