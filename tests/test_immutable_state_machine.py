...
from poker.poker_game import initialize_game_state, player_call, player_fold
...
class TestImmutableStateMachine(unittest.TestCase):
    ...
    def test_run_until_player_action_iteration_cap(self):
        ...
        with patch.object(
            PokerStateMachine, 'awaiting_action', new_callable=PropertyMock, return_value=False
        ):
    ...
    def test_chaining_operations(self):
        ...
        sm_final = sm.advance().advance().with_phase(PokerPhase.FLOP)
