...
class TestHandStrategyPersistence(unittest.TestCase):
    ...
    def test_strategy_set_on_first_action(self):
        ...
        self.assertEqual(self.player.current_hand_strategy, "Aggressive push with medium hands")
    ...
    def test_strategy_persists_through_hand(self):
        ...
        self.assertEqual(self.player.current_hand_strategy, "Tight conservative play")
...
class TestChattinessBehavior(unittest.TestCase):
    ...
    def test_contextual_modifiers(self):
        ...
        # Base probability
        base_prob = self.chattiness_manager.calculate_speaking_probability(0.5, {})
        ...
        bluff_prob = self.chattiness_manager.calculate_speaking_probability(0.5, {'bluffing': True})
...
class TestMandatoryInnerMonologue(unittest.TestCase):
    ...
    def test_response_validation_requires_inner_monologue(self):
        ...
        # Valid response
        valid_response = {"action": "fold", "inner_monologue": "This hand is terrible"}
...
class TestResponseProcessing(unittest.TestCase):
    ...
    def test_remove_speech_from_quiet_player(self):
        ...
        with patch('random.random', return_value=0.5):  # Won't speak at 0.1 chattiness
            processed = self.processor.validate_and_process_response(self.player, response, {})
...
class TestIntegrationScenarios(unittest.TestCase):
    ...
    def test_full_hand_scenario(self, mock_assistant_class):
        ...
        self.assertEqual(gordon.current_hand_strategy, "Aggressive - push hard and intimidate")
        self.assertEqual(eeyore.current_hand_strategy, "Tight - only play premium hands")
