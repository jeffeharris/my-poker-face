...
class TestFallbackStrategies(unittest.TestCase):
    ...
    def test_random_valid_fallback(self):
        ...
        for _ in range(20):
            result = mock_ai_call(
                valid_actions=valid_actions, call_amount=50, min_raise=10, max_raise=100
            )
    ...
    def test_personality_based_fallback(self):
        ...
        mock_aggressive_call = mock_aggressive_call.__get__(
            aggressive_controller, type(aggressive_controller)
        )
        ...
        for _ in range(10):
            result = mock_aggressive_call(
                valid_actions=["fold", "call", "raise"], call_amount=50, min_raise=10, max_raise=100
            )
