...
TOP_45_HANDS = TOP_35_HANDS | {
    ...
    'QJo',
    'QTo',
    'JTo',  # Offsuit broadway
    'K7s',
    'K6s',
    'K5s',
    'K4s',
    'K3s',
    'K2s',  # Remaining suited kings
    'Q8s',
    'J8s',
    'T8s',  # Suited one-gappers
    '97s',
    '86s',
    '75s',
    '64s',
    '53s',
    '43s',  # Suited connectors
    'A9o',
    'A8o',
    'A7o',
    'A6o',
    ...
    'A2o',  # Offsuit aces
    'J9o',
    'T9o',  # Offsuit one-gap connectors
}  # ~45% (76 hands)
...
TOP_55_HANDS = TOP_45_HANDS | {
    ...
    'Q4s',
    'Q3s',
    'Q2s',  # Remaining suited queens
    'J7s',
    'T7s',  # Suited mid gappers
    '98o',
    '87o',  # Offsuit connectors
}  # ~55% (93 hands)

TOP_65_HANDS = TOP_55_HANDS | {
    'K4o',
    'K3o',
    'K2o',  # Weak offsuit kings
    'Q7o',
    'Q6o',
    'Q5o',  # Weak offsuit queens
    'J8o',
    'T8o',  # Offsuit mid gappers
    'J6s',
    'J5s',
    'J4s',
    'J3s',
    'J2s',  # Remaining suited jacks
    '96s',
    '85s',
    '74s',
    '63s',  # Suited gappers
...
TOP_75_HANDS = TOP_65_HANDS | {
    'Q4o',
    'Q3o',
    'Q2o',  # Remaining offsuit queens
    'J7o',
    'J6o',
    'J5o',  # Weak offsuit jacks
    'T6s',
    'T5s',
    'T4s',
    'T3s',
    'T2s',  # Remaining suited tens
    '76o',
    '65o',
    '54o',  # Offsuit connectors
    '52s',
    '42s',
    '32s',  # Smallest suited connectors
}  # ~75% (127 hands)
...
TOP_85_HANDS = TOP_75_HANDS | {
    ...
    '94s',
    '93s',
    '92s',  # Remaining suited nines
    '84s',
    '83s',
    '82s',  # Remaining suited eights
    '73s',
    '72s',  # Remaining suited sevens
    '62s',  # Last suited six
    'J4o',
    'J3o',
    'J2o',  # Remaining offsuit jacks
...
TOP_95_HANDS = TOP_85_HANDS | {
    ...
    'T4o',
    'T3o',
    'T2o',  # Remaining offsuit tens
    '96o',
    '95o',
    '94o',
    '93o',
    '92o',  # Remaining offsuit nines
    '85o',
    '84o',
    '83o',
    '82o',  # Remaining offsuit eights
    '75o',
    '74o',
    '73o',  # Most remaining offsuit sevens
}  # ~95% (160 hands)
