...
class TableManager(AIPokerPlayer):
    def __init__(self):
        super().__init__(name="Cookie Masterson")
    ...
    def summarize_actions(self, actions: List[str] or str) -> str:
        ...
        if actions is str:
            ...
            summary_request = f"Please summarize the actions and comments since the last turn in the style of Walter Cronkite: {actions}\n"
