---
title: How Not to Be the Fish
description: "Every archetype in this series has a flaw you exploit. The fish is the player whose flaws get exploited. Here are the leaks that mark you as the fish, and how to find your own before someone else does."
...
You now know every type at the table, including the one in the mirror. [Open practice mode](/login) and let the coach find your leak, or read the [full roster](/opponents/) and go hunt someone else's.
