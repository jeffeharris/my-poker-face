---
title: How to Beat a Tight-Aggressive Player (the TAG)
description: "The tight-aggressive player is the one you can't trick. You don't beat a good TAG with a move. You beat them by plugging your own leaks, staying out of their way, and finding the easier money."
...
Their craft shows up in how they play. [Sherlock Holmes](/opponents/sherlock-holmes/) is calculating and selectively aggressive, exploiting reads with precision. [Socrates](/opponents/socrates/) lures opponents into self-destruction, slow-playing and trapping. [Sun Tzu](/opponents/sun-tzu/) strikes only when he detects weakness. [Machiavelli](/opponents/machiavelli/) makes every move serve a hidden end, and [Nikola Tesla](/opponents/nikola-tesla/) attacks from unconventional angles most players never see coming. [Benjamin Franklin](/opponents/benjamin-franklin/), [Queen Elizabeth I](/opponents/queen-elizabeth-i/), and [A Mime](/opponents/a-mime/) round out a deep bench of patient, precise aggressors.
...
Play clean, keep it small, and put your hours where the money is. [Take a seat](/login), or read the [full roster](/opponents/) and notice who is wearing the Shark tag before you buy in.
