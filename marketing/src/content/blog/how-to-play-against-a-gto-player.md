---
title: How to Play Against a Balanced (GTO) Player
description: "You can't really beat a perfectly balanced player. You can only break even. So the winning move is to stop trying and go find someone who isn't balanced. Here's what GTO means for your game, and why this game is built around its opposite."
...
Every other archetype here has a hole. The [station](/blog/how-to-beat-a-calling-station/) calls too much, the [maniac](/blog/how-to-beat-a-maniac/) bets too much, the [nit](/blog/how-to-play-against-a-nit/) folds too much, and even the [shark](/blog/how-to-beat-a-tight-aggressive-player/) and the [LAG](/blog/how-to-beat-a-lag/) lean in directions you can exploit. A balanced player, the kind aspiring to GTO, has no lean. That is the whole idea, and it changes the goal completely.
...
What the roster does have is a handful of players who play *balanced*, which is close enough to teach the lesson. [Mark Twain](/opponents/mark-twain/) is folksy and observant, blending patience with aggression so you can never quite settle on a read. [Leonardo da Vinci](/opponents/leonardo-da-vinci/) approaches every hand from a novel angle. [Oscar Wilde](/opponents/oscar-wilde/) and [William Shakespeare](/opponents/william-shakespeare/) both read the room and adapt, and the [Cheshire Cat](/opponents/cheshire-cat/) picks his spots carefully and keeps you guessing. Even these are not unexploitable. Look closely at their profiles and the small tendencies are still there, a touch sticky, a little reluctant to bluff. Those tiny leans are your edge, and finding them is the game.
...
Play balance straight, and spend your real effort on the players who do not. [Take a seat](/login), or read the [full roster](/opponents/) and notice that almost everyone there has a tell worth finding.
