        ...
        <div className="career-stats">
            ...
            <div className="history-section">
              ...
              <div className="tournament-list">
                {tournaments.map((t) => (
                  <div
                    key={t.game_id}
                    className={`tournament-row ${t.your_position === 1 ? 'winner' : ''}`}
                  >
          ...
          <div className="badges-section">
            <h3 className="section-title">
              Collection
              <span className="badge-count">{eliminatedPersonalities.length} eliminated</span>
            </h3>
                ...
                {selectedBadge && (
                  <div className="badge-info">
                    <div className="badge-info-header">
                      ...
                      <button className="badge-info-close" onClick={() => setSelectedBadge(null)}>
                        x
                      </button>
                    </div>
                    <div className="badge-info-details">
                      ...
                      <span>
                        First: {new Date(selectedBadge.first_eliminated_at).toLocaleDateString()}
                      </span>
                    </div>
                  </div>
                )}
