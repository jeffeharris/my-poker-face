...
export const MobileWinnerAnnouncement = memo(function MobileWinnerAnnouncement({
  ...
  const handleToggleSarcastic = (next: boolean) => {
    ...
    <div className="mobile-winner-overlay" data-testid="winner-overlay">
      ...
      <div className="mobile-winner-content">
        ...
        {winnerInfo.is_final_hand && winnerInfo.tournament_outcome && (
          <div
            className={`mobile-tournament-outcome-banner ${winnerInfo.tournament_outcome.human_won ? 'victory' : 'defeat'}`}
          >
        ...
        {winnerInfo.showdown && (
          <div className="winner-header">
            ...
            <div className="winner-amount" data-testid="winner-amount">
              ${totalWinnings}
            </div>
            {winnerInfo.hand_name && !hasSidePots && (
              <div className="winner-hand-name" data-testid="winner-hand-name">
                    ...
                    return (
                      ...
                      >
                        <div className="showdown-player-header">
                          <span className="showdown-player-name">{showdownPlayerName}</span>
                        </div>
                            ...
                            {playerInfo.hand_name && (
                              <div className="showdown-hand-name">
                                ...
                                {playerInfo.kickers && playerInfo.kickers.length > 0 && (
                                  <span className="showdown-kickers">
                                    {' '}
          ...
          (() => {
            ...
            return (
              <div className="no-showdown-winner" data-testid="no-showdown-winner">
                ...
                <div className="no-showdown-name" data-testid="no-showdown-name">
                  {winnerName}
                </div>
                <div className="no-showdown-amount" data-testid="no-showdown-amount">
                  Wins ${totalWinnings}
                </div>
                <div className="no-showdown-text" data-testid="no-showdown-text">
        ...
        <div className="mobile-winner-chat-bar">
          {loading ? (
            ...
            <div className="post-round-suggestions">
              <div className="post-round-suggestions-bar">
                <button className="post-round-back" onClick={handleBackToTones}>
                  <ArrowLeft size={14} />
                ...
                {selectedTone && SARCASM_ABLE_POST_ROUND.has(selectedTone) && (
                  <button
                    className={`post-round-sarcastic ${sarcastic ? 'active' : ''}`}
