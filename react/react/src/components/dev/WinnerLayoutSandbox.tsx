...
const SCENARIOS: Scenario[] = [
    {
        ...
        winnerInfo: {
            ...
            community_cards: [c('A', 'Hearts'), c('K', 'Spades'), c('A', 'Diamonds'), c('K', 'Clubs'), c('4', 'Hearts')],
            players_showdown: {
                Batman: {
    ...
    },
    {
        ...
        winnerInfo: {
            ...
            community_cards: [c('10', 'Spades'), c('J', 'Diamonds'), c('Q', 'Hearts'), c('K', 'Clubs'), c('3', 'Spades')],
            players_showdown: {
                Batman: {
    ...
    },
    {
        ...
        players: [
            mkPlayer('Batman', 'smug', 9200),
            mkPlayer('Gordon Ramsay', 'angry', 1800),
        ],
        winnerInfo: {
            winners: ['Batman'],
            showdown: false,
