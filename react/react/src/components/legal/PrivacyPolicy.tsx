    ...
    <PageLayout variant="top" glowColor="sapphire" maxWidth="md">
      ...
      <div className="legal-page">
        ...
        <section>
          <h2>Introduction</h2>
          <p>
            My Poker Face ("we", "our", or "us") is operated by Jeff Harris. This Privacy Policy
            explains how we collect, use, and protect your information when you use our poker game
            application.
          </p>
        </section>
